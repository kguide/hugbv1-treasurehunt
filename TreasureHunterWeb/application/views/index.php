...
<head>
<base href="http://hgphoto.net/treasure/ci/" />
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<title>Treasure Hunter</title>

<link href="system/application/views/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div id="mainWrapper">
	<div id="header">
		<div id="logo">
			<?php echo anchor('/','<img src="system/application/views/images/logo.png" border="0">') ?>
		</div>
		<div id="menuBar">		
	...
	<div id="footerWrapper">
		<div id="footerText">Treasure Hunt | <? echo anchor('/','www.ourGreatDomain.com');?></div>
	</div>	
</div>

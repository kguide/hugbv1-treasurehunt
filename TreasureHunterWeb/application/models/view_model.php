...
var $userMenu;
	...
	private function getUserMenuArray(){
		...
		$this->userMenu['game/myGames/'] = 'My games';
		$this->userMenu['game/createGame/'] = 'Create a Game';
		$this->userMenu['game/playedGames/'] = 'Played Games';
		$this->userMenu['highscores/'] = 'Highscores';
